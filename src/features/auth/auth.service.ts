...
import { passwordChangedEmail, welcomeEmail } from '@lib/mail/templates.js';
...
export class AuthService {
  ...
  async register(
    ...
    this.mail.dispatch({ to: user.email, content: welcomeEmail(user.name) });
  ...
  async changePassword(
    ...
    this.mail.dispatch({ to: user.email, content: passwordChangedEmail(user.name) });
