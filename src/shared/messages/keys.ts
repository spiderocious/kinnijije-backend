...
export const MESSAGE_KEYS = {
  ...
  stock: {
    FETCHED: 'stock.fetched',
    ADDED: 'stock.added',
    UPDATED: 'stock.updated',
    REMOVED: 'stock.removed',
    NOT_FOUND: 'stock.not_found',
    UNIT_EXISTS: 'stock.unit_exists',
  },
  market: {
    FETCHED: 'market.fetched',
    ADDED: 'market.added',
    REMOVED: 'market.removed',
  ...
  jobs: {
    ...
    NOT_CANCELLABLE: 'jobs.not_cancellable',
    NOT_RETRYABLE: 'jobs.not_retryable',
    CANCELLED: 'jobs.cancelled',
    RETRIED: 'jobs.retried',
  },
  kitchen: {
    FETCHED: 'kitchen.fetched',
    SAVED: 'kitchen.saved',
  },
  onboarding: {
